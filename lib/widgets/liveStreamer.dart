// widgets/liveStreamer.dart (page uniquement pour le streamer)
...
class _LiveStreamerPageState extends State<LiveStreamerPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.streamers.isEmpty) return const SizedBox();

    // Position initiale du bouton radial
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. LA GRILLE VIDÉO (Directe, sans PageView)
          LiveVideoGrid(
          ...
          // 3. OVERLAY POUR FERMER LE MENU AU CLIC EXTÉRIEUR
          if (_menuOpen)
            Positioned.fill(
