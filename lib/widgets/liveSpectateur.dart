      ...
      body: Stack(
        children: [
          PageView.builder(
            ...
            itemCount: widget.streamers.length,
            itemBuilder: (_, index) {
              //final List<StreamerModel> streamers = StreamersForLive[index];
...
// ------------------------------------------------------------------------
// SINGLE VIDEO : MODE SPECTATEUR (REMOTE ONLY)
// ------------------------------------------------------------------------
...
class SingleVideo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      fit: StackFit.expand,
      children: [
        /// ✅ SPECTATEUR = REMOTE VIDEO UNIQUEMENT
        AgoraVideoView(
